...
var author$project$Main$pathroot = '';
...
var author$project$Main$init = F3(
	function (flags, url, key) {
		...
		return _Utils_Tuple2(
			{key: key, modules: modules, page: author$project$Main$Readme, readme: flags.readme},
			A2(elm$browser$Browser$Navigation$replaceUrl, key, author$project$Main$pathroot));
	});
var author$project$Main$ModulesReceived = function (a) {
	return {$: 'ModulesReceived', a: a};
};
var author$project$Main$ReadmeReceived = function (a) {
	return {$: 'ReadmeReceived', a: a};
};
var elm$json$Json$Decode$value = _Json_decodeValue;
var author$project$Main$modulesReceived = _Platform_incomingPort('modulesReceived', elm$json$Json$Decode$value);
var author$project$Main$readmeReceived = _Platform_incomingPort('readmeReceived', elm$json$Json$Decode$string);
var elm$core$Platform$Sub$batch = _Platform_batch;
var author$project$Main$subscriptions = function (model) {
	return elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				author$project$Main$readmeReceived(author$project$Main$ReadmeReceived),
				author$project$Main$modulesReceived(author$project$Main$ModulesReceived)
			]));
};
var author$project$Main$Module = function (a) {
	return {$: 'Module', a: a};
};
var author$project$Main$filesSelected = _Platform_outgoingPort('filesSelected', elm$core$Basics$identity);
	...
	function (msg, model) {
		switch (msg.$) {
			case 'FilesSelected':
				...
				return _Utils_Tuple2(
					model,
					author$project$Main$filesSelected(files));
			case 'ReadmeReceived':
				var string = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							page: author$project$Main$Readme,
							readme: elm$core$Maybe$Just(string)
						}),
					elm$core$Platform$Cmd$none);
			case 'ModulesReceived':
				var value = msg.a;
				var _n1 = A2(
				...
				if (_n1.$ === 'Ok') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{modules: modules, page: author$project$Main$Readme}),
						elm$core$Platform$Cmd$none);
				} else {
					var err = _n1.a;
			...
			case 'UrlRequested':
				var request = msg.a;
				var _n2 = A2(elm$core$Debug$log, 'urlRequested', request);
				if (request.$ === 'Internal') {
					var url = request.a;
					return _Utils_Tuple2(
						model,
			...
			default:
				...
				var _n5 = A2(elm$core$List$member, module_, modules);
				if (_n5) {
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								page: author$project$Main$Module(module_)
							}),
						elm$core$Platform$Cmd$none);
				} else {
					return _Utils_Tuple2(
...
var author$project$Main$footer = A2(
	...
	_List_fromArray(
		[
			elm$html$Html$text('All code for this site is '),
			A2(
			elm$html$Html$a,
			_List_fromArray(
				[
					elm$html$Html$Attributes$class('grey-link'),
					elm$html$Html$Attributes$href('https://github.com/dmy/elm-doc-preview')
				]),
			_List_fromArray(
				[
					elm$html$Html$text('open source')
				])),
			elm$html$Html$text(' and written in Elm.')
		]));
...
var author$project$Main$filesInput = A2(
	elm$html$Html$div,
	_List_fromArray(
		[
...
var author$project$Main$logo = A2(
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					elm$svg$Svg$Attributes$width('50px'),
					elm$svg$Svg$Attributes$height('70px'),
					elm$svg$Svg$Attributes$viewBox('0 0 210 297')
				]),
			_List_fromArray(
				[
					A2(
					...
					_List_fromArray(
						[
							elm$svg$Svg$Attributes$d('M61.8 132v92.7l46.3-46.3-46.3-46.3z'),
					...
					_List_fromArray(
						[
							elm$svg$Svg$Attributes$d('M83 59.9L62.9 80.2 83 100.5z'),
					...
					_List_fromArray(
						[
							elm$svg$Svg$Attributes$d('M109 184.1l-65.4 65.5H109v-65.5z'),
					...
					_List_fromArray(
						[
							elm$svg$Svg$Attributes$d('M145 217.6l-32.1 32H143l32-32z'),
					...
					_List_fromArray(
						[
							elm$svg$Svg$Attributes$d('M59.4 83.5l-22.7 22.7 22.7 22.7 22.7-22.7z'),
							elm$svg$Svg$Attributes$fill('#7fd13b')
						]),
					_List_Nil),
					A2(
					...
					_List_fromArray(
						[
							elm$svg$Svg$Attributes$d('M35.8 59.9v40.6L56 80.2z'),
							elm$svg$Svg$Attributes$fill('#f0ad00')
						]),
					_List_Nil),
					A2(
					...
					_List_fromArray(
						[
							elm$svg$Svg$Attributes$d('M57 132l-31 31.2 31 31v-62.1z'),
							elm$svg$Svg$Attributes$fill('#60b5cc')
						]),
					_List_Nil)
				])),
			...
			_List_fromArray(
				[
					...
					A2(elm$html$Html$Attributes$style, 'transform', 'translateX(-20px)')
				]),
			_List_fromArray(
				[
					A2(
				...
				[
					...
					_List_fromArray(
						[
							...
							function () {
							if (targetPage.$ === 'Readme') {
								return elm$html$Html$Attributes$href(author$project$Main$pathroot);
							} else {
								var name = targetPage.a;
								return elm$html$Html$Attributes$href(
									author$project$Main$pathroot + ('/' + A3(elm$core$String$replace, '.', '-', name)));
							}
						}(),
							_Utils_eq(currentPage, targetPage) ? A2(elm$html$Html$Attributes$style, 'font-weight', 'bold') : A2(elm$html$Html$Attributes$style, '', ''),
							_Utils_eq(currentPage, targetPage) ? A2(elm$html$Html$Attributes$style, 'text-decoration', 'underline') : A2(elm$html$Html$Attributes$style, '', '')
						]),
					_List_fromArray(
						[
							function () {
							if (targetPage.$ === 'Readme') {
								return elm$html$Html$text('README');
							} else {
								var name = targetPage.a;
...
var author$project$Main$navLinks = F2(
	function (currentPage, pages) {
		return A2(
			...
			A2(
				elm$core$List$map,
				author$project$Main$navLink(currentPage),
				pages));
	});
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				author$project$Main$filesInput,
				function () {
				var _n0 = model.readme;
				if (_n0.$ === 'Just') {
					return A2(
						author$project$Main$navLinks,
						model.page,
						_List_fromArray(
				...
				A2(
					elm$core$List$map,
					function (m) {
						return author$project$Main$Module(m.name);
					},
					model.modules))
			]));
};
var author$project$Main$WithoutParentheses = {$: 'WithoutParentheses'};
var author$project$Main$boldLink = function (ref) {
	return A2(
		elm$html$Html$a,
		_List_fromArray(
			[
...
var author$project$Main$indent = F2(
	function (attributes, children) {
		return A2(
			...
			A2(
				elm$core$List$cons,
				A2(elm$html$Html$Attributes$style, 'margin-left', '2rem'),
				attributes),
			children);
	});
var author$project$Main$markdownOptions = {
...
var author$project$Main$markdown = function (string) {
	return A3(elm_explorations$markdown$Markdown$toHtmlWith, author$project$Main$markdownOptions, _List_Nil, string);
};
var author$project$Main$WithParentheses = {$: 'WithParentheses'};
var elm$html$Html$span = _VirtualDom_node('span');
var author$project$Main$indentIf = F3(
	function (cond, attributes, children) {
		return cond ? A2(author$project$Main$indent, attributes, children) : A2(elm$html$Html$span, attributes, children);
	});
var author$project$Main$var = function (string) {
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					elm$html$Html$text(' : '),
					A2(author$project$Main$tipe, author$project$Main$WithoutParentheses, fieldType)
				]));
	});
var author$project$Main$fields = F2(
	function (prefix, list) {
		if (list.b) {
			...
			return A2(
				...
				A2(
					elm$core$List$cons,
					A3(author$project$Main$field, elm$html$Html$span, prefix, f),
					A2(
						elm$core$List$map,
						A2(author$project$Main$field, elm$html$Html$div, ','),
						fs)));
		} else {
			return elm$html$Html$text(prefix);
		}
	});
var author$project$Main$lambda = F2(
	function (t1, t2) {
		return A2(
			elm$html$Html$span,
			_List_Nil,
					...
					if (t1.$ === 'Lambda') {
						return A2(
							...
							_List_fromArray(
								[
									elm$html$Html$text('('),
									A2(author$project$Main$tipe, author$project$Main$WithoutParentheses, t1),
									elm$html$Html$text(')')
								]));
					} else {
						return A2(author$project$Main$tipe, author$project$Main$WithoutParentheses, t1);
					}
				}(),
					elm$html$Html$text(' -> '),
					A2(author$project$Main$tipe, author$project$Main$WithoutParentheses, t2)
				]));
	});
var author$project$Main$record = F2(
	function (fields_, rowType) {
		if (rowType.$ === 'Just') {
			var r = rowType.a;
			return A3(
				author$project$Main$indentIf,
				elm$core$List$length(fields_) > 1,
				_List_Nil,
				_List_fromArray(
					[
						elm$html$Html$text('{ '),
						...
						_List_fromArray(
							[
								A2(author$project$Main$fields, '|', fields_)
							])),
						elm$html$Html$text('}')
					]));
		} else {
...
var author$project$Main$tipe = F2(
	function (typeStyle, t) {
		switch (t.$) {
			case 'Var':
				var string = t.a;
				return author$project$Main$var(string);
			case 'Lambda':
				var t1 = t.a;
				var t2 = t.b;
				return A2(author$project$Main$lambda, t1, t2);
			case 'Tuple':
				var list = t.a;
				return author$project$Main$tuple(list);
			case 'Type':
				var name = t.a;
				var types = t.b;
				return A3(author$project$Main$typ, typeStyle, name, types);
			default:
				var fields_ = t.a;
				var rowType = t.b;
				return A2(author$project$Main$record, fields_, rowType);
		}
	});
var author$project$Main$tipes = F3(
	function (typeStyle, separator, types) {
		return A2(
			elm$html$Html$span,
			_List_Nil,
			A2(
				elm$core$List$intersperse,
				elm$html$Html$text(separator),
				A2(
					elm$core$List$map,
					author$project$Main$tipe(typeStyle),
					types)));
	});
var author$project$Main$tuple = function (types) {
	return elm$core$List$isEmpty(types) ? elm$html$Html$text('()') : A2(
		elm$html$Html$span,
		_List_Nil,
		_List_fromArray(
			[
				elm$html$Html$text('( '),
				A3(author$project$Main$tipes, author$project$Main$WithoutParentheses, ', ', types),
				elm$html$Html$text(' )')
			]));
};
var author$project$Main$typ = F3(
	function (typeStyle, name, types) {
		var shortName = A2(
			elm$core$Maybe$withDefault,
			name,
			elm$core$List$head(
		...
		return elm$core$List$isEmpty(types) ? A2(
			elm$html$Html$span,
			_List_fromArray(
				[
					elm$html$Html$Attributes$title(name),
					elm$html$Html$Attributes$class('hljs-type')
				]),
			_List_fromArray(
				[
					elm$html$Html$text(shortName)
				])) : (_Utils_eq(typeStyle, author$project$Main$WithParentheses) ? A2(
			elm$html$Html$span,
			_List_Nil,
			_List_fromArray(
				[
...
var author$project$Main$aliasBlock = function (alias) {
	return A2(
		elm$html$Html$div,
		_List_fromArray(
			[
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								elm$html$Html$text('alias')
							])),
						elm$html$Html$text(' '),
						author$project$Main$boldLink(alias.name),
						elm$html$Html$text(' '),
						(elm$core$List$length(alias.args) > 0) ? elm$html$Html$text(
						A2(elm$core$String$join, ' ', alias.args) + ' = ') : elm$html$Html$text('='),
						A2(
						author$project$Main$indent,
						_List_Nil,
						_List_fromArray(
							[
								A2(author$project$Main$tipe, author$project$Main$WithoutParentheses, alias.tipe)
							]))
					])),
				A2(
				elm$html$Html$div,
				...
				_List_fromArray(
					[
						author$project$Main$markdown(alias.comment)
					]))
			]));
};
var author$project$Main$binopBlock = function (binop) {
	var op = '(' + (binop.name + ')');
	return A2(
		elm$html$Html$div,
		_List_fromArray(
			[
				elm$html$Html$Attributes$id(op),
				elm$html$Html$Attributes$class('docs-block')
			]),
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						author$project$Main$boldLink(op),
						elm$html$Html$text(' : '),
						A2(author$project$Main$tipe, author$project$Main$WithoutParentheses, binop.tipe)
					])),
				A2(
				elm$html$Html$div,
				_List_fromArray(
				...
				_List_fromArray(
					[
						author$project$Main$markdown(binop.comment)
					]))
			]));
};
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							elm$html$Html$Attributes$class('hljs-literal')
						]),
					_List_fromArray(
						[
					...
					elm$html$Html$text(' '),
					A3(author$project$Main$tipes, author$project$Main$WithParentheses, ' ', types)
				]));
	});
var author$project$Main$tags = function (tags_) {
	if (!tags_.b) {
		return elm$html$Html$text('');
	} else {
		var t = tags_.a;
...
var author$project$Main$unionBlock = function (union) {
	return A2(
		elm$html$Html$div,
		_List_fromArray(
			[
				elm$html$Html$Attributes$id(union.name),
				elm$html$Html$Attributes$class('docs-block')
			]),
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						...
						elm$html$Html$text(' '),
						author$project$Main$boldLink(union.name),
						elm$html$Html$text(' '),
						elm$html$Html$text(
						A2(elm$core$String$join, ' ', union.args)),
						author$project$Main$tags(union.tags)
					])),
				A2(
				elm$html$Html$div,
				_List_fromArray(
				...
				_List_fromArray(
					[
						author$project$Main$markdown(union.comment)
					]))
			]));
};
var author$project$Main$valueBlock = function (value) {
	return A2(
		elm$html$Html$div,
		_List_fromArray(
			[
				elm$html$Html$Attributes$id(value.name),
				elm$html$Html$Attributes$class('docs-block')
			]),
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						author$project$Main$boldLink(value.name),
						elm$html$Html$text(' : '),
						A2(author$project$Main$tipe, author$project$Main$WithoutParentheses, value.tipe)
					])),
				A2(
				elm$html$Html$div,
				_List_fromArray(
				...
				_List_fromArray(
					[
						author$project$Main$markdown(value.comment)
					]))
			]));
};
var author$project$Main$block = function (b) {
	switch (b.$) {
		case 'MarkdownBlock':
			var string = b.a;
			return author$project$Main$markdown(string);
		case 'UnionBlock':
			var union = b.a;
			return author$project$Main$unionBlock(union);
		case 'AliasBlock':
			var alias = b.a;
			return author$project$Main$aliasBlock(alias);
		case 'ValueBlock':
			var value = b.a;
			return author$project$Main$valueBlock(value);
		case 'BinopBlock':
			var binop = b.a;
			return author$project$Main$binopBlock(binop);
		default:
			var string = b.a;
			return A2(
				elm$html$Html$div,
...
var elm$project_metadata_utils$Elm$Docs$toBlocks = function (docs) {
	var _n0 = A2(elm$core$String$split, '\n@docs ', docs.comment);
	if (!_n0.b) {
		return _List_Nil;
	} else {
		var firstMarkdown = _n0.a;
		var docsChunks = _n0.b;
		return A2(
			elm$core$List$cons,
...
var author$project$Main$doc = function (docs) {
	return A2(
		elm$core$List$cons,
		A2(
			elm$html$Html$h1,
...
var author$project$Main$page = function (model) {
	return A2(
		...
		function () {
			var _n0 = model.page;
			if (_n0.$ === 'Readme') {
				var _n1 = model.readme;
				if (_n1.$ === 'Just') {
					var readme = _n1.a;
					return _List_fromArray(
						[
							author$project$Main$markdown(readme)
						]);
				} else {
					return elm$core$List$isEmpty(model.modules) ? _List_fromArray(
						[
							author$project$Main$markdown(author$project$Main$howto)
						]) : _List_fromArray(
						[
							author$project$Main$markdown(author$project$Main$howtoWithModules)
						]);
				}
			} else {
				var name = _n0.a;
				...
				if (_n2.b && (!_n2.b.b)) {
					var module_ = _n2.a;
					return author$project$Main$doc(module_);
				} else {
					return _List_fromArray(
						[
							A2(
